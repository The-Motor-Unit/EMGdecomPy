...
def test_log_cosh():
    ...
    for i in range (0, 5):
        ...
        # using np.isclose() because small (<1 e-16)rounding errors possible
        assert np.isclose(x_tanh, emg.log_cosh(x, der=True)), "First derivative contrast function incorrectly calculated."
