...
```{r algo-visual-summary, echo=FALSE, fig.cap = "Visual step-by-step summary of the blind-source separation algorithm from Negro et al paper.", fig.align="center", out.width="90%"}
