...
Motor neurons are a specific subclass of neurons that create a junction between the central nervous system and the muscular system [@purves_2018]. Motor neurons attach to fibers in the muscle, forming an entity known as a motor unit, as seen in **figure \@ref(fig:EMG-ex)a**. When struck by action potential, the motor unit generates motor unit action potential (MUAP), a burst of electrical activity specific to the motor unit that produced it [@purves_2018]. The MUAP signal causes the muscle fibers attached to the motor unit to contract.
