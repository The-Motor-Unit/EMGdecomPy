...
1.  `EMGdecomPy` is open-source, meaning that the code is publicly hosted on GitHub and accessible to the general public. This is a desirable attribute for the capstone partner because it allows the algorithms' code to be easily inspected, which is ideal for troubleshooting results and publishing research. The GitHub repo contains thoroughly documented and tested functions that make up the decomposition steps described in the @negro_muceli_castronovo_holobar_farina_2016 pseudocode.
